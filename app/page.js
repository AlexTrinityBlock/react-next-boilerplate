            ...
            <header className="bg-black py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex justify-center gap-4 mt-8">
                        <a href="/about" className="inline-block px-6 py-3 bg-[#FF5733] text-white rounded-lg font-semibold shadow-[0_4px_20px_rgba(255,87,51,0.2)] hover:shadow-[0_8px_25px_rgba(147,112,219,0.3)] transition-all duration-300 hover:-translate-y-1">
                            關於本站
                        </a>
                        <a href="/faq" className="inline-block px-6 py-3 bg-[#FF5733] text-white rounded-lg font-semibold shadow-[0_4px_20px_rgba(255,87,51,0.2)] hover:shadow-[0_8px_25px_rgba(147,112,219,0.3)] transition-all duration-300 hover:-translate-y-1">
                            常見問題
                        </a>
                    </div>
